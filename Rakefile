...
%i[ claude codex gemini opencode ].each do |llm|
  namespace llm do
    misspellings = "#{__dir__}/opt/#{llm}/data/turkish/misspellings.tsv"
    ...
    confusables = "#{__dir__}/opt/#{llm}/data/turkish/confusables.tsv"
