...
corrections. Review the Turkish content in @$ARGUMENTS and respond in Turkish:

- **Grammar and Spelling**
  - Verify adherence to Turkish grammar and orthography.
  - Identify common misspellings by consulting `~/.claude/data/turkish/misspellings.tsv` (a TSV file with a header
    row).
