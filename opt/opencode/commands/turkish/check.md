...
- **Grammar and Spelling**
  ...
  - Identify common misspellings by consulting @~/.local/share/opencode/data/turkish/misspellings.tsv (a TSV file with a header row).

- **Semantic Precision**
  - Detect frequently confused terms using @~/.local/share/opencode/data/turkish/confusables.tsv (a TSV file with a header row).
